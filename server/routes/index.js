...
router.get('/rankings/user/:username', itemsController.getPersonalRankings);
...
router.post('/admin/seed-popular-culture', adminAuth, adminController.triggerSeedPopularCulture);
