/**
 * Wrapper for seed-categories script that can be imported as a module
...
// Category mappings with alternatives
const CATEGORIES = [
  ...
  { name: 'Other Things', primary: [], alternatives: [] }
];
...
async function seedCategories() {
  ...
  return { totalAdded, totalSkipped, finalCount, previousCount: currentCount };
}
